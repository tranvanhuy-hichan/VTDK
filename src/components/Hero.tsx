...
export const Hero: React.FC<HeroProps> = ({ company }) => {
  return (
    <section id="trang-chu" className="relative bg-gradient-to-b from-slate-50 via-white to-[#F6F8FA] dark:from-slate-900 dark:via-slate-950 dark:to-[#0F172A] pt-12 sm:pt-16 lg:pt-20 pb-16 sm:pb-20 overflow-hidden transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col text-left">
            ...
            <span className="text-xs sm:text-sm font-extrabold text-[#075FA8] dark:text-amber-400 tracking-widest uppercase mb-3 sm:mb-4 block">
              Công ty TNHH Vật Tư Đông Kha
            </span>
            {/* Main Headline */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-[1.18] mb-4 sm:mb-6">
              Giải pháp vật tư điện lạnh{" "}
              <span className="text-[#075FA8] dark:text-blue-400 underline decoration-[#F47A20] underline-offset-8">
                đáng tin cậy
              </span>{" "}
              tại Đà Nẵng
            </h1>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 sm:gap-4 mb-8 sm:mb-10">
              ...
              <a
                ...
                className="flex items-center justify-center gap-3 bg-[#075FA8] hover:bg-[#0B1F33] dark:hover:bg-[#075FA8]/80 text-white font-bold text-lg px-6 py-4 rounded-xl shadow-lg shadow-blue-700/25 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5"
              >
              ...
              <a
                href="#dia-chi"
                className="inline-flex items-center justify-center gap-1.5 text-slate-700 dark:text-slate-300 hover:text-[#075FA8] dark:hover:text-amber-400 font-bold text-base px-4 py-3 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-colors text-center"
              >
            ...
            <div className="pt-6 border-t border-slate-200/80 dark:border-slate-850 grid grid-cols-3 gap-2 sm:gap-4">
              <div className="flex items-center gap-2 text-slate-800 dark:text-slate-200 font-semibold text-xs sm:text-sm">
                <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600 dark:text-emerald-455 shrink-0" />
          ...
          <div className="lg:col-span-5 relative mt-4 lg:mt-0">
            <div className="relative mx-auto max-w-lg lg:max-w-none">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white dark:border-slate-800 bg-slate-900 aspect-[4/3] sm:aspect-[16/11]">
                <ImageCarousel
                ...
                <div className="absolute bottom-3 left-3 right-3 sm:bottom-4 sm:left-4 sm:right-4 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md p-3 sm:p-4 rounded-xl border border-slate-200/80 dark:border-slate-800 shadow-lg flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-orange-100 dark:bg-orange-950 text-[#F47A20] flex items-center justify-center shrink-0">
                    <MapPin className="w-5 h-5 fill-orange-500 text-orange-600" />
                  </div>
                  <div className="flex flex-col text-left overflow-hidden">
                    <span className="text-[11px] font-bold text-[#075FA8] dark:text-amber-400 uppercase tracking-wide">Địa chỉ cửa hàng</span>
