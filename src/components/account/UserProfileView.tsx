...
export const UserProfileView: React.FC = () => {
    ...
    return (
      <section className="pt-2 sm:pt-4 pb-16 bg-[#F6F8FA] dark:bg-[#071626] min-h-screen">
        <div className="w-full max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
          <ProductDetailHeader productName="Tài khoản cá nhân" />
  ...
  if (!user) {
    return (
      <section className="pt-2 sm:pt-4 pb-16 bg-[#F6F8FA] dark:bg-[#071626] min-h-screen text-slate-800 dark:text-slate-100">
        <div className="w-full max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-8 space-y-4 text-left">
          <ProductDetailHeader productName="Tài khoản cá nhân" />
          <div className="max-w-md mx-auto text-center pt-8">
            <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-8 space-y-4 shadow-xs">
              ...
              <h2 className="text-lg font-black text-slate-900 dark:text-white">Đăng nhập để quản lý tài khoản</h2>
  ...
  return (
    <section className="pt-1.5 sm:pt-2.5 pb-16 bg-[#F6F8FA] dark:bg-[#071626] min-h-screen text-slate-800 dark:text-slate-100 transition-colors duration-300">
      <div className="w-full max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-8 space-y-3 sm:space-y-4 text-left">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
          ...
          <div className="lg:col-span-4 space-y-4">
            {/* User Overview Card */}
            <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-5 sm:p-6 shadow-xs space-y-4 text-center">
              <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-[#075FA8] to-[#00A896] text-white flex items-center justify-center text-2xl font-black mx-auto shadow-md">
              ...
              <div>
                ...
                {user.role === "ADMIN" ? (
                  <span className="inline-flex items-center gap-1 mt-2 px-3 py-1 bg-amber-100 dark:bg-amber-950/60 text-amber-800 dark:text-amber-300 text-xs font-bold rounded-full border border-amber-200 dark:border-amber-900">
                    <ShieldCheck className="w-3.5 h-3.5" /> Quản trị viên
                  </span>
                ) : (
                  <span className="inline-flex items-center gap-1 mt-2 px-3 py-1 bg-blue-50 dark:bg-blue-950/60 text-[#075FA8] dark:text-blue-300 text-xs font-bold rounded-full border border-blue-200 dark:border-blue-900">
            ...
            {/* Navigation Tabs */}
            <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-2 shadow-xs space-y-1">
              <button
                type="button"
                onClick={() => {
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-2xl text-xs sm:text-sm font-bold transition-all text-left cursor-pointer !min-h-0 ${
                  activeTab === "profile"
          ...
          <div className="lg:col-span-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-5 sm:p-7 shadow-xs">
            {activeTab === "profile" ? (
              <form onSubmit={handleUpdateProfile} className="space-y-5">
                ...
                <div className="pt-3 border-t border-slate-100 dark:border-slate-800 flex justify-end">
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-[#075FA8] hover:bg-[#0B1F33] text-white font-bold text-xs sm:text-sm py-2.5 px-6 rounded-xl shadow-md transition-all active:scale-98 disabled:opacity-50 cursor-pointer !min-h-0"
                  >
                    {profileSaving ? (
