...
export const Testimonials: React.FC = () => {
  ...
  return (
    <section className="py-16 sm:py-20 bg-[#F6F8FA] dark:bg-[#0F172A] relative border-t border-slate-200 dark:border-slate-800 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {list.map((item, index) => (
            <div
              key={index}
              className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 shadow-xs flex flex-col justify-between relative group hover:border-blue-200 dark:hover:border-blue-500 hover:shadow-md transition-all duration-300 text-left"
            >
              <div>
                {/* Quote Icon Overlay */}
                <div className="absolute top-6 right-6 text-slate-100 dark:text-slate-800 pointer-events-none group-hover:text-blue-50 dark:group-hover:text-slate-700 transition-colors">
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-xs text-slate-400 dark:text-slate-500 block mt-0.5 font-medium leading-none">
                    {item.role}
                  </span>
                </div>
              </div>
