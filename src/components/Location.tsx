...
export const Location: React.FC = () => {
  return (
    <section id="lien-he" className="py-16 sm:py-24 bg-[#F6F8FA] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div id="dia-chi" className="lg:col-span-7 order-2 lg:order-1 flex flex-col">
            <div className="bg-white rounded-3xl overflow-hidden border border-slate-200 shadow-lg flex-1 min-h-[340px] sm:min-h-[420px] relative">
              <iframe
          ...
          <div className="lg:col-span-5 order-1 lg:order-2 flex flex-col justify-between bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-lg text-left">
            ...
            <div>
              ...
              <div className="space-y-5 mb-8">
                ...
                <div className="flex items-start gap-3.5">
                  <div className="p-3 bg-blue-50 text-[#075FA8] rounded-xl shrink-0 mt-0.5">
                    <MapPin className="w-5 h-5 fill-blue-600 text-blue-700" />
                  </div>
                  <div>
                    <span className="text-xs font-bold text-slate-500 uppercase tracking-wider block mb-0.5">
                      Địa chỉ cửa hàng
                    </span>
                    <span className="text-base sm:text-lg font-extrabold text-slate-900 leading-snug block">
                ...
                {/* Hotline Item */}
                <div className="flex items-start gap-3.5">
                  <div className="p-3 bg-orange-50 text-[#F47A20] rounded-xl shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-xl sm:text-2xl font-black text-[#075FA8] hover:text-[#0B1F33] transition-colors block"
                    >
            ...
            <div className="pt-6 border-t border-slate-100 grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 bg-[#EA4335] hover:bg-red-700 text-white font-extrabold py-3 px-3 rounded-xl shadow transition-colors text-sm"
              >
              ...
              <a
                href={`tel:${COMPANY_DATA.hotlineRaw}`}
                className="flex items-center justify-center gap-2 bg-[#075FA8] hover:bg-[#0B1F33] text-white font-extrabold py-3 px-3 rounded-xl shadow transition-colors text-sm"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 bg-[#0068FF] hover:bg-blue-700 text-white font-extrabold py-3 px-3 rounded-xl shadow transition-colors text-sm"
              >
